...
const UploadSummaryStep: React.FC<Props> = ({
  fileName,
  selectedCategory,
  artworkName,
  handleUpload,
  ...
  return (
    <Box sx={{ mt: 3, textAlign: "center" }}>
      ...
      <Stack spacing={1.5} sx={{ width: "100%", textAlign: "right" }}>
        <Box>
          <Typography variant="body2" color="text.secondary">שם הקובץ:</Typography>
        ...
        <Box>
          <Typography variant="body2" color="text.secondary">שם/תיאור:</Typography>
...
export default UploadSummaryStep
