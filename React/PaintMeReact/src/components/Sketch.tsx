...
// //           navigate("/login")   // או הנתיב שלכם לדף ההתחברות
// //         }
// //       })
// //   }, [navigate])
...
// //         context.drawImage(canvas, 0, 0, newCanvas.width, newCanvas.height)
// //       }
// //       console.log("newCanvas.width", newCanvas);
...
//         img.onload = () => {
//           try {
//             // חישוב יחס נכון כמו בפונקציה המקורית
//             const ratio = Math.min(newCanvas.width / img.width, newCanvas.height / img.height)
//             const x = (newCanvas.width - img.width * ratio) / 2
//             const y = (newCanvas.height - img.height * ratio) / 2
            
//             // ציור תמונת הרקע ביחס הנכון
