...
const theme = createTheme({
  ...
  palette: {
    ...
    secondary: {
      main: "#7BD1D1", // Soft teal
      light: "#9EEAEA",
      dark: "#5BAEAE",
      contrastText: "#ffffff",
    },
    background: {
      default: "#FFF9F5", // Very light peach
      paper: "#ffffff",
    },
    text: {
      primary: "#5D5D81", // Soft purple-gray
      secondary: "#7E7E9A",
    },
    error: {
  ...
  typography: {
    fontFamily: '"Heebo", "Poppins", "Roboto", "Helvetica", "Arial", sans-serif',
    h1: {
      fontWeight: 700,
    },
    h2: {
  ...
  shape: {
    borderRadius: 16, // More rounded corners for a playful look
  },
  shadows: [
    "none",
  ...
  components: {
    MuiButton: {
      styleOverrides: {
        root: {
          borderRadius: 30, // Very rounded buttons
          boxShadow:
        ...
        contained: {
          "&:hover": {
            boxShadow:
              "0px 6px 10px -3px rgba(0,0,0,0.12),0px 10px 14px 1px rgba(0,0,0,0.07),0px 4px 18px 3px rgba(0,0,0,0.05)",
          },
        },
      },
    },
