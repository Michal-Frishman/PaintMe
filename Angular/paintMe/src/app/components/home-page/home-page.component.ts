...
//   constructor(private categoriesService: CategoriesService, private usersService: UsersService, private filesService: FilesService) {
//         this.categories$ = this.categoriesService.categories$;     
//         this.users$ = this.usersService.users$;
//         this.files$ = this.filesService.files$;
//    }
//   stats = [
//     { title: 'משתמשים', value:  this.users$.length, icon: 'people', color: 'users' },
//     { title: 'ציורים', value: this.files$.length,, icon: 'brush', color: 'drawings' },
//     { title: 'קטגוריות', value: this.categories$.length,, icon: 'category', color: 'categories' },
//     // { title: 'העלאות', value: this.categories$.length,, icon: 'cloud_upload', color: 'uploads' }
//   ];
// }
import { Component } from '@angular/core';
